  ...
  return (
    <div className="h-full flex flex-col bg-surface">
      ...
      <div className="px-4 py-3 flex items-center">
        <button onClick={() => navigate(-1)} className="text-ink-secondary p-1">
      ...
      <div className="flex-1 px-6 pb-10 flex flex-col">
        ...
        <div className="bg-bg rounded-xl p-5 space-y-4">
          {[
            ...
            <div key={row.feature} className="flex items-center">
              <p className="flex-1 text-sm text-ink">{row.feature}</p>
              <p className="w-16 text-center text-sm text-ink-tertiary">{row.free}</p>
          ...
          <div className="flex items-center pt-2 border-t border-line">
            <p className="flex-1" />
            <p className="w-16 text-center text-[11px] text-ink-tertiary font-medium">Free</p>
        ...
        <div className="mt-auto pt-6">
          <button
            onClick={() => navigate(-1)}
            className="w-full text-center text-sm text-ink-tertiary py-2"
          >
            Maybe later
          </button>
        </div>
